...
export class PostResolverBase {
  ...
  async createPost(@graphql.Args() args: CreatePostArgs): Promise<Post> {
    return await this.service.create({
      ...
      data: {
        ...
        sharingUsers: args.data.sharingUsers
          ? {
              connect: args.data.sharingUsers,
            }
          : undefined,
  ...
  async resolveFieldSharingUsers(
    @graphql.Parent() parent: Post
  ): Promise<User | null> {
    const result = await this.service.getSharingUsers(parent.id);
  ...
  async resolveFieldUser(@graphql.Parent() parent: Post): Promise<User | null> {
